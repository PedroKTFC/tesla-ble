...
<<<<<<< HEAD
typedef PB_BYTES_ARRAY_T(400) UniversalMessage_RoutableMessage_protobuf_message_as_bytes_t;
=======
>>>>>>> parent of 780ba6a (Try reverting to last working size)
...
<<<<<<< HEAD
#define UniversalMessage_RoutableMessage_size    629
=======
>>>>>>> parent of 780ba6a (Try reverting to last working size)
