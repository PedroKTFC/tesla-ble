...
#include "common.pb.h"
#include "google/protobuf/timestamp.pb.h" // This is not included in the previous version so delete if build fails (trying with it in to minimise "hand" changes")
